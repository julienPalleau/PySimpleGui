...
"""
    ...
    This is an unusual demo. It's using a class to implement the individual graphs. Could be a great
    design pattern in many ways.  See what you can do with it!
    Copyright 2018, 2019, 2020 PySimpleGUI.org (it's an old program)
"""
